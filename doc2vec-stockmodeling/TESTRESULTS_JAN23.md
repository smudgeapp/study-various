...
Here again the similarity results are hardly any different except for in one case. There is no way the positive and negative representative vectors could have been same. It may be that the vector size is too small and it is stuck at a minimum, but the result is the same as in t1m1 where the vector size was anything but small.
